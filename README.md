...
**A local-first training ground for coding interviews.** It is not a checklist app — it is a referee. It puts a clock on you, refuses to let you fool yourself, and keeps a permanent record of what you can actually do unaided.

Built around the [Striver A2Z / TUF+](https://takeuforward.org/) DSA sheet (435 problems), plus everything else placement interviews actually test: spaced repetition, blind pattern recognition, core CS theory, system design, online-assessment simulations, mock interviews, and defending your own projects under hostile questioning.

```
npm start   →   http://localhost:4350
```

**Zero dependencies. No `npm install`. No build step. No database. No account. No cloud.** One Node file serves the app; everything you do is stored as readable JSON in `./data` on your own machine.

![Mission Control](docs/screenshots/mission.png)

<details>
<summary><b>More screenshots</b> — the Arena, evidence gates, the Grill Room, weak-topic analysis…</summary>

### Evidence gates — the scoreboard that can't be gamed
Six gates. Your readiness equals your **weakest** one. Nothing you can click raises them.
![Evidence gates and the war plan](docs/screenshots/warplan.png)

### The Grill Room — defend your own projects
Ships with two worked example dossiers so you can see the shape and the level of honesty expected.
